...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dataType/createDataType": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建DataType",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Customize.DataType"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Customize.SetMachineServiceReq"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "Customize.SetMachineServiceReq": {
            "type": "object",
            "required": [
                "machineID",
                "services"
            ...
            "properties": {
                ...
                "services": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/Customize.PropStatus"
                        }
                    }
                }
            }
