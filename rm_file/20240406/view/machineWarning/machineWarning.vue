<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="告警联系人ID" prop="reporter_id" width="120" />
...
import {
  ...
  deleteMachineWarning,
  deleteMachineWarningByIds,
...
const getTableData = async() => {
  const table = await getMachineWarningList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
